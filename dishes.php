        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/foodiezlogo.png" alt=""> </a>
        ...
        <div class="page-wrapper">
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/img/dishh.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
